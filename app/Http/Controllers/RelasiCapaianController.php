...
class RelasiCapaianController extends Controller
{
    ...
    private function loadPdf(Pemagangan $pemagang)
    {
        ...
        return \PDF::loadView('pdf.index',compact('pemagang', 'capaian', 'nilai_akhir', 'jhm','jlhd', 'nks'))->setPaper('a4','landscape');
    }
