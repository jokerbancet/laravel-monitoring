            ...
            <div class="panel">
                <div class="panel-body">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>{{ $mahasiswa->laporan->count() }}</td>
                                <td>{{ $laporan_dinilai }}</td>
                                <td>{{ $laporan_belum_dinilai }}</td>
                                <td>{{ $mahasiswa->laporan->where('status_laporan', 'approve')->count() }}</td>
                            </tr>
                        </tbody>
                    </table>
                    @livewire('detail-persetujuan-mahasiswa', compact('mahasiswa'))
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="/persetujuan/laporan_id/approve" id="form-modal" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi_pekerjaan" disabled cols="30" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
