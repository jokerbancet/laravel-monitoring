                        ...
                        <div class="profile-detail">
                            <div class="profile-info">
                                ...
                                <ul class="list-unstyled list-justify">
                                    <li>Email <span>{{ $dpi->email }}</span></li>
                                    <li>Jenis Kelamin <span>{{ $dpi->jk }}</span></li>
                                    <li>Industri <span>{{ $dpi->industri->nama_industri }}</span></li>
                                </ul>
                            </div>
                            <div class="margin-top-30 text-center">
                                <a href="/pembimbingindustri/{{$dpi->id}}/edit" class="btn btn-warning">Edit Data</a>
