            ...
            <div class="row">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Edit Data HRD</h3>
                        @if(session('sukses'))
                    ...
                    <div class="panel-body">
                        <form action="/hrd/{{ $dpi->id }}/update" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <button href="/hrd" class="btn btn-warning" >Kembali</button>
                            </div>
                        </form>
                    </div>
                </div>
